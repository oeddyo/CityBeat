class Stopwords:
	@staticmethod
	def stopwords():
		self_defined = set(['nyc', 'ny', 'new', 'york', 'newyork', 'park', 
		                    'central', 'day', 'christmas', 'xmas', 'manhattan'])
		nltk_list = set(['i', 'me', 'my', 'myself', 'we', 'our', 'ours',
		...
		return self_defined.union(nltk_list)